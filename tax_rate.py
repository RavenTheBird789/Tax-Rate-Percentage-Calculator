...
def tax_rate():
    initial_price = int(float(input("Initial Price: "))); # ask user for listed price of something
    final_price = int(float(input("Final Price: "))); # ask user the final price paid for something after tax
